...
local base_group = lush(function()
	return {
		...
		VertSplit({ fg = vert_split, bg = bg2 }),
		Folded({ fg = yellow, bg = bg1, gui = styles.italic_strings }),
		...
		TabLineFill({ fg = fg4, bg = magenta, gui = styles.invert_tabline }),
